...
export const Search = () => {
  ...
  return (
    ...
    >
      ...
      {value && (
        <X
          className="absolute top-2.5 right-14 h-5 w-5 text-muted-foreground cursor-pointer hover:opacity-75 transition duration-500"
          onClick={onClear}
        />
      )}
      <Button 
        ...
        size="sm"
        variant="secondary"
        className="rounded-l-none hover:opacity-75 transition duration-500"
      >
